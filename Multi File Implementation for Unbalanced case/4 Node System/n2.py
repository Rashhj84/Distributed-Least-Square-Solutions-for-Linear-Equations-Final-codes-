...
port_num = 12346    # Local nodes port number
...
def run_consensus(s,alpha,iter,xt):
    ...
    for _ in range(iter):
        ...
        if(ii%gaps==0):
            ...
            log_state(f"x_{node_id}.csv",node_id, ii, x) #This line adds the x values to csv file
            # log_state(f"y_{node_id}.csv",node_id, ii, y) #This line adds y the values to csv file
            # log_state(f"ld_{node_id}.csv",node_id, ii, ld) #This line adds z the values to csv file
