...
if __name__ == "__main__":
    nodes = [("127.0.0.1",12345,1), ("127.0.0.1",12346,2), ("127.0.0.1",12347,3), ("127.0.0.1",12348,4)]   #Node information is stored in this list
    ...
    iteration_number = 15000  #Its upto the user to decide the number of iterations. More the iterations accurate are the results
    sleep_time = 0.005       #Sleep time has some constraints
    gaps = 100
    initiation = 15
    # neighbors = [
    #     [],
